...
export default function AddCategory() {
    ...
    function handleSubmit(e){
        ...
        try{
            ...
            console('ajout de categorie reussie');
        }
        catch(error){
    ...
    const confirmDelete = () => {
        try {
            ...
            console.log(`Produit avec ID ${selectedCategory} supprimé`);
                ...
                {categories?.length > 0 ? (
                    categories.map((category) => {
                        ...
                        <div key={category.id} className='w-full bg-white rounded-md px-2 flex gap-4 items-center justify-between'>
                            ...
                            <button className='block px-2 py-1 bg-red-500 duration-300 ease-in-out hover:bg-red-800 rounded-md cursor-pointer text-white' 
