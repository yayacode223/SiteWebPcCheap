        ...
        <div class="max-w-md w-full">
          ...
          <div class="p-8 rounded-2xl bg-white shadow">
            ...
            <form class="mt-8 space-y-4">
              ...
              <p class="text-gray-800 text-sm !mt-8 text-center">Avez vous deja un compte ? <a href="javascript:void(0);" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">S'inscrire</a></p>
            </form>
          </div>
        </div>
      </div>
