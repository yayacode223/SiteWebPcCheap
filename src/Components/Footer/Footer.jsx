  ...
  <footer class="mx-auto max-w-screen-2xl px-4 md:px-8">
    <div class="mb-16 grid grid-cols-2 gap-12 pt-10 md:grid-cols-4 lg:grid-cols-6 lg:gap-8 lg:pt-12">
      <div class="col-span-full lg:col-span-2">
        ...
        <p class="mb-6 text-gray-400 sm:pr-8">Rejoignez nous sur nos differents reseaux sociaux</p>
      ...
      {/*-- nav - start --*/}
      <div>
        <div class="mb-4 font-bold uppercase tracking-widest text-gray-100">Nos Produits</div>
      ...
      {/*-- nav - start --*/}
      <div>
        <div class="mb-4 font-bold uppercase tracking-widest text-gray-100">Entreprise PCCHEAP</div>

        <nav class="flex flex-col gap-4">
          <div>
            <a href="#" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">A propos</a>
          </div>
      ...
      <div>
        ...
        <nav class="flex flex-col gap-4">
          <div>
            <a href="#" class="text-gray-400 transition duration-100 hover:text-indigo-500 active:text-indigo-600">Contacts</a>
          </div>
    ...
    <div class="border-t border-gray-800 py-8 text-center text-sm text-gray-400">© {year}  - ENTREPRISE PCCHEAP. TOUS DROITS RESERVES.</div>
  </footer>
</div>
  );
};
